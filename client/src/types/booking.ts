...
export const bookingFormSchema = z.object({
  ...
  pickupLatitude: z.string().nullable().optional(),
  pickupLongitude: z.string().nullable().optional(),
  dropoffLatitude: z.string().nullable().optional(),
  dropoffLongitude: z.string().nullable().optional(),
